...
// In production (Vercel), use the full API URL. In dev, use the proxy.
const API_BASE = import.meta.env.VITE_MAHORAGA_API_URL 
  ? `${import.meta.env.VITE_MAHORAGA_API_URL}/agent`
  : '/api'
